...
try: 
    ...
    try: 
        ...
        print( "SUKSESS - kan importere nvdbapiv4 etter at vi la til", nvdblibrary, "i sys.path" )
else:
    print( "HURRA - vi kan importere nvdbapiv4 " ) 
